...
TEST(CollisionEntityProjectile, SamePosCollides) {
  EXPECT_TRUE(Collision::EntityProjectile(Vec2(0, 0), 6, Vec2(0, 0), 32));
}

TEST(CollisionEntityProjectile, FarApartNoCollision) {
  EXPECT_FALSE(
      Collision::EntityProjectile(Vec2(0, 0), 6, Vec2(1000, 1000), 32));
}
